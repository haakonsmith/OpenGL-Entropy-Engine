...
class RightTriangle : public ShapeBase
{

public:
  RightTriangle(GLuint shader_program_id, GLuint init_memory_type);
...
// init function
RightTriangle::RightTriangle(GLuint shader_program_id, GLuint init_vbo)
{
